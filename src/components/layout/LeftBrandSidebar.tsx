  ...
  const categories = [
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="w-5 h-5 text-[#38b000]">
          {/* Potted plant icon */}
    ...
    <aside className="w-full lg:w-[260px] xl:w-[290px] shrink-0 bg-white border-r border-[#e8ece4] px-4 py-4 flex flex-col justify-between items-center text-center relative lg:h-[calc(100vh-5rem)]">
      ...
      <div className="relative w-full flex flex-col items-center">
        ...
        <div className="absolute top-1 left-1 z-20 text-left -rotate-6 select-none pointer-events-none">
          <div className="font-script text-xl sm:text-2xl text-[#38b000] leading-[1.05] tracking-tight drop-shadow-xs">
            Greener <br />
            Spaces <br />
            Happier <br />
            People ♡
        ...
        <div className="inline-flex flex-col space-y-2.5 items-start">
          {categories.map((cat, idx) => (
            <Link
              key={idx}
              href={cat.href}
              className="group flex items-center gap-3 text-[11px] sm:text-xs font-semibold text-[#1f3328] hover:text-[#38b000] transition-all"
            >
      ...
      <div className="pt-1 pb-1 -rotate-3 text-center select-none">
        <p className="font-script text-xl sm:text-2xl text-[#38b000] leading-tight flex items-center justify-center gap-1.5">
